<template>
  <div id="page-wrapper">
    ...
    <section>
      ...
      <p>On my first shallow dive into Vue I was immediately hooked.  React is arguably the industry's popular front end approach to modern web apps and most of my projects are React-centric.  But this portfolio site was to be the core of all my programming work and I wanted it to stand apart.  Wading into completely uncharted waters, I made Vue the backbone of this site.</p>
